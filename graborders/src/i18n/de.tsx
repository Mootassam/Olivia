...
const de = {
  ...
  pages: {
    home: {
      ...
      welcome: "Willkommen",
      announcement: "Liebe Benutzer, die gotomarketers-Plattform ist wieder im besten und normalen Zustand, verdienen Sie weiterhin so viel wie möglich von der Plattform",
