...
const fr = {
  ...
  pages: {
    home: {
      ...
      welcome: "Bienvenue",
      announcement: "Chers utilisateurs, la plateforme gotomarketers est de retour au meilleur et normal, continuez à gagner autant que possible depuis la plateforme",
