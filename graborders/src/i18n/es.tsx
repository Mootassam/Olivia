...
const es = {
  ...
  pages: {
    home: {
      ...
      welcome: "Bienvenido",
      announcement: "Estimados usuarios, la plataforma gotomarketers ha vuelto a la normalidad y a su mejor estado, continúen ganando tanto como puedan desde la plataforma",
